...
class MessageSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $messages = [
            ...
            [
                'keycloak_user_id' => $demoUserId,
                'sender_name'      => 'Gestion Client',
                'sender_email'     => 'noreply@gestion-client.local',
                'subject'          => 'Bienvenue sur votre espace, connexion SSO active',
                'body'             => "Bonjour,\n\nVotre compte a été connecté avec succès à l'application Gestion Client via l'authentification SSO Keycloak (Realm : CompanyRealm).\n\nVous pouvez désormais accéder à tous vos espaces sans avoir à vous reconnecter.\n\nBonne journée !",
                'folder'           => 'inbox',
                'is_read'          => true,
                'is_starred'       => true,
